...
bin/brogue : ${DEPENDENCIES} ${BROGUEFILES}
	$(CC) -O2 -march=i586 -o bin/brogue.html -s EMTERPRETIFY=1 -s EMTERPRETIFY_ASYNC=1 -s EMTERPRETIFY_BLACKLIST='["_javascript_plotChar"]' ${BROGUEFILES} ${LIBRARIES} -Wl,-rpath,.
